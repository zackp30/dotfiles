...
From https://gist.github.com/jrnold/675584
  ...
  #+BEGIN_SRC emacs-lisp :tangle yes
    ...
    (defun cdr-or-second (cons-or-list)
      (scase (symbol-name (type-of cons-or-list))
             ("cons" (cdr cons-or-list))
             ("list" (second cons-or-list))))
    ...
    (use-package autoinsert
      ...
      (map nil (lambda (x)
                 (let ((mode-name (symbol-name (cdr-or-second x)))
                       (regex (first x)))
