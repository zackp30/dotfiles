...
** Todo states
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
     org-todo-keywords '((sequence "TODO" "|" "NOT REQUIRED" "ABANDONED" "DONE")))
   #+END_SRC

** Finally, import the LaTeX package
...
** PDF
   :PROPERTIES:
   :DOTF_DISABLED: <2015-12-15 Tue>
   :End:

   LaTeX should be run 3 times to make sure cross-references are correct.
   ...
   #+BEGIN_SRC emacs-lisp :tangle yes
     (defun my-org-confirm-babel-evaluate (lang body)
       (not (or (string= lang "dot") ;; don't ask to run a Graphviz block
                (string= lang "puml")))) ;; don't ask for PlantUML blocks
