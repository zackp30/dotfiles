...
(defun ac-ispell--document (complete)
  "Completes dictionary definition"
  (shell-command-to-string (format "LD_LIBRARY_PATH=/usr/local/lib64 dict -h dict.org %s" complete)))
